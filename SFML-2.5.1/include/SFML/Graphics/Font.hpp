...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Holds various information about a m_font
    ///
    ////////////////////////////////////////////////////////////
    struct Info
    {
        std::string family; ///< The m_font family
    };
...
public:
    ...
    ///
    /// This constructor defines an empty m_font
    ///
    ////////////////////////////////////////////////////////////
    Font();
    ...
    /// \brief Destructor
    ///
    /// Cleans up all the internal resources used by the m_font
    ///
    ////////////////////////////////////////////////////////////
    ~Font();

    ////////////////////////////////////////////////////////////
    /// \brief Load the m_font from a file
    ///
    /// The supported m_font formats are: TrueType, Type 1, CFF,
    /// OpenType, SFNT, X11 PCF, Windows FNT, BDF, PFR and Type 42.
    /// Note that this function knows nothing about the standard
    /// fonts installed on the user's system, thus you can't
    /// load them directly.
    ///
    /// \warning SFML cannot preload all the m_font data in this
    /// function, so the file has to remain accessible until
    /// the sf::Font object loads a new m_font or is destroyed.
    ///
    /// \param filename Path of the m_font file to load
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Load the m_font from a file in memory
    ///
    /// The supported m_font formats are: TrueType, Type 1, CFF,
    /// OpenType, SFNT, X11 PCF, Windows FNT, BDF, PFR and Type 42.
    ///
    ...
    /// valid until the sf::Font object loads a new m_font or
    /// is destroyed.
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Load the m_font from a custom stream
    ///
    /// The supported m_font formats are: TrueType, Type 1, CFF,
    /// OpenType, SFNT, X11 PCF, Windows FNT, BDF, PFR and Type 42.
    /// Warning: SFML cannot preload all the m_font data in this
    /// function, so the contents of \a stream have to remain
    /// valid as long as the m_font is used.
    ///
    /// \warning SFML cannot preload all the m_font data in this
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Get the m_font information
    ///
    /// \return A structure that holds the m_font information
    ///
    ////////////////////////////////////////////////////////////
    const Info& getInfo() const;

    ////////////////////////////////////////////////////////////
    /// \brief Retrieve a glyph of the m_font
    ///
    /// If the m_font is a bitmap m_font, not all character sizes
...
private:
    ...
    void*                      m_face;        ///< Pointer to the internal m_font face (it is typeless to avoid exposing implementation details)
    ...
    Info                       m_info;        ///< Information about the m_font
...
/// types of information about the m_font:
...
///
/// Fonts alone are not very useful: they hold the m_font data
...
/// copy the m_font that it uses, it only keeps a reference to it.
...
/// }
///
/// // Create a text which uses our m_font
/// sf::Text text1;
/// text1.setFont(m_font);
/// text1.setCharacterSize(30);
/// text1.setStyle(sf::Text::Regular);
///
/// // Create another text using the same m_font, but with different parameters
/// sf::Text text2;
...
/// \endcode
///
/// Apart from loading m_font files, and passing them to instances
/// of sf::Text, you should normally not have to deal directly
/// with this class. However, it may be useful to access the
/// m_font metrics or rasterized glyphs for advanced usage.
///
/// Note that if the m_font is a bitmap m_font, it is not scalable,
...
/// corresponding bitmap m_font that supports that size is used.
///
/// \see sf::Text
///
////////////////////////////////////////////////////////////
